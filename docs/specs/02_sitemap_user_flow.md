...
graph TD
    ...
    Speaking --> T1[People]
    Speaking --> T2[Food and Drink]
    Speaking --> T3[Work]
    Speaking --> T4[Travel]
    Speaking --> T5[The Environment]
    Speaking --> T6[Animals]
    Speaking --> T7[Activities]
    Speaking --> T8[Around Town]
    Speaking --> T9[Arts and the Media]
    Speaking --> T10[Science and Technology]
    Speaking --> T11[Health]
    Speaking --> T12[Crime and the Law]
    Speaking --> T13[Money and Finance]
